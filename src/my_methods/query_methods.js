...
async function GetPreference() {
    try {
      const response_color = await axios.get('https://hwamqnsad7.us-east-2.awsapprunner.com/adopter/tastes/colors', '');
      const response_size = await axios.get('https://hwamqnsad7.us-east-2.awsapprunner.com/adopter/tastes/sizes', '');
