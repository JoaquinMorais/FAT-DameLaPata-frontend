...
export async function FetchNavbarItems() {
  ...
  export async function SendLogin(data_to_send) {
    let response = null;
    try {
      response = await axios.post('https://hwamqnsad7.us-east-2.awsapprunner.com/login', data_to_send);
  ...
  export async function GetProfile(){
    var cosa = await axios.post('https://hwamqnsad7.us-east-2.awsapprunner.com/profile', {
