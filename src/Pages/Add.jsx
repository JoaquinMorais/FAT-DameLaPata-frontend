...
function Add() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get('https://hwamqnsad7.us-east-2.awsapprunner.com/pets/info/characteristics'); 
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    axios
      .put('https://hwamqnsad7.us-east-2.awsapprunner.com/pet', dataToSend)
      .then((response) => {
